class ParserLL1:
    ...
    def sentencia_id(self):
        """sentencia_id → op_asignacion expresion | tk_corchete_izq expresion tk_corchete_der tk_asig expresion | tk_par_izq args_opt tk_par_der"""
    ...
    def atom_suffix(self):
        """atom_suffix → tk_par_izq args_opt tk_par_der atom_suffix | tk_corchete_izq expresion tk_corchete_der atom_suffix | ε"""
        if self.token_actual.tipo == "tk_par_izq":
            self.match("tk_par_izq")
            self.args_opt()
            self.match("tk_par_der")
